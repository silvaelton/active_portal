...
SimpleForm.setup do |config|
  ...
  config.wrappers :semantic, tag: 'div', class: "field", error_class: 'error', hint_class: 'with_hint' do |b|
    ...
    b.use :error, wrap_with: { tag: 'div', class: 'error error-text' }
  end
  ...
  config.wrappers :ui_file_upload, tag: 'div', class: 'field fileupload', error_class: 'error', hint_class: 'with_hint' do |b|
    b.use :html5
    b.use :input, class: 'hidden'
    b.use :label, class: 'ui icon button'
  end
